...
char MY_SENSOR_METADATA[] = "HHZ EG-125 AirQuality_A"; // Friendly-name of the sensor (replace "TAG" with your individual tag)
...
void setup() {
  ...
  float calibrVal = 0;
  float i = 1; // Set calibration duration to 5 minutes
