...
#define MY_RF24_CHANNEL  0 // Channel
#define MY_NODE_ID 2 // Node id
char MY_SENSOR_METADATA[] = "HHZ EG-120 HumidTemp_A"; // Friendly-name of the sensor (replace _TAG_ with your individual tag and _LOC_ with the location of the sensor)
...
{  
  ...
  Serial.println(MY_SENSOR_METADATA);
