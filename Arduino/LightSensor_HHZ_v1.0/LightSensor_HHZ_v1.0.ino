...
char MY_SENSOR_METADATA[] = "HHZ EG-126_2 Light_A"; // Friendly-name of the sensor (replace _TAG_ with your individual tag and _LOC_ with the location of the sensor)
...
{     
  ...
  Serial.println("Brightness in lx:");
  Serial.println(lux);
  send(msg.set(lux)); 
  sleep(SLEEP_TIME);
}
